...
namespace PostgresDemo.Services;
...
public class ProductIndexingService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Indexing {Count} products...", products.Count);
            ...
            _logger.LogInformation("Product indexing complete!");
        }
        catch (Exception ex)
        {
            _logger.LogError(ex, "Failed to index products. Make sure PostgreSQL is running with pgvector extension.");
        }
    }
}
