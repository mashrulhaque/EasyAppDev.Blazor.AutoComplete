...
/// <summary>
/// Indexer for adding items to Pinecone vector store.
/// </summary>
/// <typeparam name="TItem">The item type to index.</typeparam>
public class PineconeVectorIndexer<TItem> : IVectorIndexer<TItem>
{
    ...
    /// <summary>
    /// Creates a new Pinecone vector indexer.
    /// </summary>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var batch in itemList.Chunk(_options.IndexBatchSize))
        {
            ...
            try
            {
                ...
                // Create records
                var records = batch.Select((item, index) => PineconeVectorRecord.Create(
