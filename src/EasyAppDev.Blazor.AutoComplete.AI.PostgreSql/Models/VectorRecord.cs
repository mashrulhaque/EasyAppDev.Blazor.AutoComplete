...
internal sealed class VectorRecord
{
    ...
    /// <summary>
    /// Creates a VectorRecord from an item using the specified options.
    /// </summary>
    /// <typeparam name="TItem">The item type.</typeparam>
    /// <param name="id">Unique identifier.</param>
    /// <param name="item">The item to store.</param>
    ...
    /// <summary>
    /// Creates a VectorRecord from an item using the specified type info.
    /// </summary>
    /// <typeparam name="TItem">The item type.</typeparam>
    /// <param name="id">Unique identifier.</param>
    /// <param name="item">The item to store.</param>
    ...
    private static VectorRecord CreateCore<TItem>(
        string id,
        TItem item,
        string text,
        ReadOnlyMemory<float> embedding,
