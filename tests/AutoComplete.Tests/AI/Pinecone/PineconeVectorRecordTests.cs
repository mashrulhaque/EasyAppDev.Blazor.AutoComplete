...
/// <summary>
/// Tests for the internal PineconeVectorRecord class.
/// Uses reflection to access internal class for testing.
/// </summary>
public class PineconeVectorRecordTests
{
    private readonly Type _vectorRecordType;
    private readonly MethodInfo _createMethod;
    private readonly MethodInfo _getItemMethod;

    public PineconeVectorRecordTests()
    {
        // Get the internal PineconeVectorRecord type via reflection
        var assembly = typeof(EasyAppDev.Blazor.AutoComplete.AI.Pinecone.PineconeVectorSearchProvider<>).Assembly;
        _vectorRecordType = assembly.GetType("EasyAppDev.Blazor.AutoComplete.AI.Pinecone.Models.PineconeVectorRecord")!;
    ...
    [Fact]
    public void PineconeVectorRecord_HasCorrectAttributes()
    {
    ...
    [Fact]
    public void PineconeVectorRecord_EmbeddingAttribute_HasCorrectDimensions()
    {
        // Arrange
        var embeddingProperty = _vectorRecordType.GetProperty("Embedding");
    ...
    [Fact]
    public void PineconeVectorRecord_Create_SerializesItemToJson()
    {
        // Arrange
    ...
    [Fact]
    public void PineconeVectorRecord_GetItem_DeserializesJsonToItem()
    {
        // Arrange
        var testItem = new TestProduct { Id = 1, Name = "Test Product", Price = 9.99m };
        var embedding = new float[] { 0.1f, 0.2f, 0.3f };
    ...
    [Fact]
    public void PineconeVectorRecord_Create_SetsAllProperties()
    {
        // Arrange
    ...
    [Fact]
    public void PineconeVectorRecord_IdProperty_IsString()
    {
        // Assert - Pinecone uses string as key type
        var idProperty = _vectorRecordType.GetProperty("Id");
        idProperty.Should().NotBeNull();
